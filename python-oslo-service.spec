...
%{?dlrn: %global tarsources oslo.service}
%{!?dlrn: %global tarsources oslo_service}
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/oslo.service/commit/226fe87b907bfa5ec6a20fbff821c89313e61649
